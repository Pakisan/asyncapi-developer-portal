---
title: Amazon SQS Server Binding v0.2.0 - Reserved for Future Use
description: An overview of the AsyncAPI SQS server binding object for version 0.2.0. Learn why this binding is reserved for future server-level configurations.
layout: doc
prev: true
next: true
head:
  ...
  - - meta
    - property: og:title
      content: Amazon SQS Server Binding v0.2.0 - Reserved for Future Use
  - - meta
    - property: og:description
      content: An overview of the AsyncAPI SQS server binding object for version 0.2.0. Learn why this binding is reserved for future server-level configurations.
  - - meta
    - property: og:type
      content: article
  - - meta
    - property: og:url
      content: https://asyncapi.pavelon.dev/bindings/amazon-sqs/0.2.0/server.html
  - - meta
    - property: og:image
...
There are no breaking changes when migrating from `v0.2.0` to `v0.3.0`, as the server binding object remains a placeholder in the newer version.