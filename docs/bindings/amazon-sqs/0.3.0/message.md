...
description: An overview of the AsyncAPI SQS message binding object for version 0.3.0. Learn why this binding is reserved for future message-level configurations.
layout: doc
prev: true
next: true
head:
  ...
  - - meta
    - property: og:description
      content: An overview of the AsyncAPI SQS message binding object for version 0.3.0. Learn why this binding is reserved for future message-level configurations.
  - - meta
    - property: og:type
      content: article
  - - meta
