---
title: AMQP Operation Binding v0.2.0 – Message Routing & Delivery
description: Configure AMQP 0-9-1 operation bindings v0.2.0 in AsyncAPI. Set message expiration, delivery modes, routing keys, priority, reply-to, and acknowledgments.
layout: doc
prev: true
next: true
head:
  - - meta
    - name: keywords
      content: AMQP operation binding v0.2.0, AsyncAPI, RabbitMQ, message routing, delivery mode, message priority, replyTo, message expiration, CC, BCC, message acknowledgment
  - - meta
    - property: og:title
      content: AMQP Operation Binding v0.2.0 – Message Routing & Delivery
  - - meta
    - property: og:description
      content: Configure AMQP 0-9-1 operation bindings v0.2.0 in AsyncAPI. Set message expiration, delivery modes, routing keys, priority, reply-to, and acknowledgments.
  - - meta
    - property: og:type
      content: article
  - - meta
    - property: og:url
      content: https://asyncapi.pavelon.dev/bindings/amqp/0.2.0/operation.html
  - - meta
    - property: og:image
      content: /bindings/amqp/0.2.0/operation.png
  - - meta
    - name: twitter:title
      content: AMQP Operation Binding v0.2.0 – Message Routing & Delivery
  - - meta
  ...
  - - link
    - rel: canonical
      href: https://asyncapi.pavelon.dev/bindings/amqp/0.2.0/operation.html
---
