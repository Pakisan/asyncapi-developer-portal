---
title: AMQP Operation Binding v0.2.0 - Message Routing and Delivery
...
head:
  - - meta
    - name: keywords
      content: AMQP operation binding, AsyncAPI, RabbitMQ, message routing, delivery mode, message priority, replyTo, message expiration, CC, BCC, message acknowledgment
  - - meta
    - property: og:title
      content: AMQP Operation Binding v0.2.0 - Message Routing and Delivery
  - - meta
