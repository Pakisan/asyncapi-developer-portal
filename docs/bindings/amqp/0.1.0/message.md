---
title: AMQP Message Binding v0.1.0 - Content Encoding and Message Type
...
head:
  - - meta
    - name: keywords
      content: AMQP message binding, AsyncAPI, RabbitMQ, contentEncoding, messageType, message properties, data serialization, legacy binding
  - - meta
    - property: og:title
      content: AMQP Message Binding v0.1.0 - Content Encoding and Message Type
  - - meta
