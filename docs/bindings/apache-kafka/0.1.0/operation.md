...
head:
  ...
  - - meta
    - property: og:url
      content: https://asyncapi.pavelon.dev/bindings/apache-kafka/0.1.0/operation.html
  - - meta
    - name: og:image
...
| `bindingVersion` | string | No | The version of the Kafka operation binding. For this version, the value is `0.1.0`. |
