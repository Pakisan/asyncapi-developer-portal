---
title: Apache Kafka Message Binding v0.4.0 - Schema Registry & Keys
description: Define Apache Kafka message bindings v0.4.0 for AsyncAPI. Configure message keys, schema registry integration, and schema evolution for robust event streaming.
layout: doc
prev: true
next: true
head:
  ...
  - - meta
    - property: og:title
      content: Apache Kafka Message Binding v0.4.0 - Schema Registry & Keys
  - - meta
