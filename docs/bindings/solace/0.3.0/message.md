---
title: Solace Message Binding v0.3.0 - Message Configuration
...
head:
  - - meta
    - name: keywords
      content: Solace message binding v0.3.0, AsyncAPI, placeholder, event mesh, event-driven architecture, message properties
  - - meta
    - property: og:title
      content: Solace Message Binding v0.3.0 - Message Configuration
  - - meta
