---
title: Solace Server Binding v0.2.0 - Message VPN Connection
description: This document details the legacy v0.2.0 of the Solace server binding. Learn to configure the connection to a Solace broker by specifying the Message VPN.
layout: doc
prev: true
next: true
head:
  ...
  - - meta
    - property: og:title
      content: Solace Server Binding v0.2.0 - Message VPN Connection
  - - meta
    - property: og:description
      content: This document details the legacy v0.2.0 of the Solace server binding. Learn to configure the connection to a Solace broker by specifying the Message VPN.
  - - meta
    - property: og:type
      content: article
  - - meta
