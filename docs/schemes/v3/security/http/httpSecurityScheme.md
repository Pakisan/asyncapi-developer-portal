...
## What is HTTP Security Scheme in AsyncAPI?

HTTP Security Scheme in AsyncAPI is a collection of authentication mechanisms that can be used to secure HTTP-based communications. It encompasses three main types of HTTP authentication:
...
## When to Use HTTP Security Scheme in AsyncAPI

HTTP Security Scheme is suitable for:
...
## AsyncAPI Schema for HTTP Security Scheme
