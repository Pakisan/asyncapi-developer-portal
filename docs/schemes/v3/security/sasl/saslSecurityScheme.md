---
title: SASL Security Scheme
layout: doc
---

# {{ $frontmatter.title }}

## What is SASL Security Scheme?
...
## When to Use SASL Security Scheme in AsyncAPI
...
- [SASL Plain Security Scheme](./saslPlainSecurityScheme.md)
- [SASL SCRAM Security Scheme](./saslScramSecurityScheme.md)
- [SASL GSS-API Security Scheme](./saslGssapiSecurityScheme.md)
